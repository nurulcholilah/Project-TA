            ...
            <div class="col-12 col-lg-12 d-flex">
                <div class="card radius-10 w-100 shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <div class="dashboard-top-countries mb-3">
                            @foreach($pengeluaranPerKategori as $kategori)
                            @php
                            $persentase = ($pengeluaran > 0) ? ($kategori->total / $pengeluaran) * 100 : 0;
                            @endphp
                            <div class="row mb-4">
                                <div class="col">
                                    <div class="d-flex justify-content-between">
                                        <p class="mb-2">{{ $kategori->kategori->keterangan }}</p>
                                        <strong class="float-end">@currency($kategori->total)</strong>
                                    </div>
