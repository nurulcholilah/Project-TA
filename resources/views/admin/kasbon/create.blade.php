            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Tambah Kasbon</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <form action="{{ route('kasbon.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="border p-4 rounded">
                                <div class="card-title d-flex align-items-center">
                                    <h5 class="mb-0">Tambah Data Kasbon</h5>
                                </div>
                                <hr>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('nominal') is-invalid @enderror" name="nominal" id="nominal" placeholder="Masukkan nominal" value="{{ old('nominal') }}">
                                        @error('nominal')
                                        <div class="alert alert-danger mt-2">
                                            {{ $message }}
                                        </div>
