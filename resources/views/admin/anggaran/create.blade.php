                        ...
                        <form action="{{ route('anggaran.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="border p-4 rounded">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('kegiatan') is-invalid @enderror" name="kegiatan" id="kegiatan" placeholder="Masukkan kegiatan" value="{{ old('kegiatan') }}">
                                        @error('kegiatan')
                                        <div class="alert alert-danger mt-2">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('volume') is-invalid @enderror" name="volume" id="volume" placeholder="Masukkan volume" value="{{ old('volume') }}">
                                        @error('volume')
                                        <div class="alert alert-danger mt-2">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <label for="jumlah" class="col-sm-3 col-form-label">Jumlah Biaya</label>
                                    <div class="col-sm-9">
