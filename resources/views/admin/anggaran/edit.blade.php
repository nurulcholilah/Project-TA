            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Form Edit Anggaran</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="mx-auto">
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body">
                        <form action="{{ route('anggaran.update', $data->id_anggaran) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <a href="{{ route('anggaran.index') }}" class="btn btn-sm"><i class="bx bx-arrow-back"></i>Kembali</a><br><br>
                            <div class="border p-4 rounded">
                                <div class="card-title d-flex align-items-center">
                                    <h5 class="mb-0">Edit Data Anggaran</h5>
                                </div>
                                <hr>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('kegiatan') is-invalid @enderror" value="{{ $data->kegiatan }}" name="kegiatan" id="kegiatan" placeholder="Masukkan kegiatan" value="{{ $data->kegiatan }}">
                                        @error('kegiatan')
                                        <div class="alert alert-danger mt-2">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('volume') is-invalid @enderror" value="{{ $data->volume }}" name="volume" id="volume" placeholder="Masukkan volume" value="{{ $data->volume }}">
                                        @error('volume')
                                        <div class="alert alert-danger mt-2">
                                            {{ $message }}
                                        </div>
